                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('main_service_id') is-invalid @enderror"
                                ...
                                @foreach($mainServices as $main)
                                    <option value="{{ $main->id }}" {{ old('main_service_id') == $main->id ? 'selected' : '' }}>
                                        {{ $main->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select @error('sub_service_id') is-invalid @enderror"
                                ...
                                @foreach($subServices as $sub)
                                    <option value="{{ $sub->id }}" data-main="{{ $sub->main_service_id }}"
                                            {{ old('sub_service_id') == $sub->id ? 'selected' : '' }}>
                                        {{ $sub->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="col-lg-4">
                <div class="dashboard-card sticky-top" style="top: 20px;">
                    ...
                    <div class="small text-muted">
                        ...
                        <ul>
                            <li>Select a main service to categorize this package</li>
                            <li>Optionally select a sub service for more specific categorization</li>
                            <li>Choose the individual services that make up this package</li>
                        </ul>
                    </div>
                </div>
            </div>
