...
<div class="fade-in">
    ...
    <div class="dashboard-card mb-4">
        <form action="{{ route('admin.integrations.index') }}" method="GET" class="row g-3">
            <div class="col-md-10">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.integrations.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.integrations.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.integrations.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
