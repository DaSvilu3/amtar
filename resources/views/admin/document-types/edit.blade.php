...
<div class="fade-in">
    ...
    <div class="row">
                ...
                <form action="{{ route('admin.document-types.update', $documentType->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('entity_type') is-invalid @enderror"
                            ...
                            <option value="client" {{ old('entity_type', $documentType->entity_type) == 'client' ? 'selected' : '' }}>
                                Client Documents
                            </option>
                            <option value="project" {{ old('entity_type', $documentType->entity_type) == 'project' ? 'selected' : '' }}>
                                Project Documents
                            </option>
                            <option value="contract" {{ old('entity_type', $documentType->entity_type) == 'contract' ? 'selected' : '' }}>
                                Contract Documents
                            </option>
                        </select>
                        @error('entity_type')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  name="description"
                                  rows="3"
                                  placeholder="Brief description of what this document is for...">{{ old('description', $documentType->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="application/pdf" id="type_pdf" {{ in_array('application/pdf', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="application/msword" id="type_doc" {{ in_array('application/msword', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="application/vnd.openxmlformats-officedocument.wordprocessingml.document" id="type_docx" {{ in_array('application/vnd.openxmlformats-officedocument.wordprocessingml.document', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="image/jpeg" id="type_jpeg" {{ in_array('image/jpeg', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="image/png" id="type_png" {{ in_array('image/png', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="application/vnd.ms-excel" id="type_xls" {{ in_array('application/vnd.ms-excel', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="file_types[]" value="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" id="type_xlsx" {{ in_array('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', old('file_types', $documentType->file_types ?? [])) ? 'checked' : '' }}>
        ...
        <div class="col-lg-4">
            <div class="dashboard-card">
                <h5 class="mb-3"><i class="fas fa-info-circle me-2"></i>Document Information</h5>
                <div class="mb-3">
                ...
                <div class="mb-0">
                    <small class="text-muted d-block mb-1">Files Count</small>
                    <strong>{{ $documentType->files ? $documentType->files->count() : 0 }} files</strong>
                </div>
            </div>

            <div class="dashboard-card mt-3">
                <h5 class="mb-3"><i class="fas fa-info-circle me-2"></i>Update Information</h5>
                <p class="text-muted small mb-2">
                    <i class="fas fa-check text-success me-2"></i>Fields marked with * are required
                </p>
                <p class="text-muted small mb-2">
                    <i class="fas fa-check text-success me-2"></i>Slug must be unique across all types
                </p>
                <p class="text-muted small mb-2">
                    <i class="fas fa-exclamation-triangle text-warning me-2"></i>Changing entity type may affect existing files
                </p>
                <p class="text-muted small mb-0">
                    <i class="fas fa-exclamation-triangle text-warning me-2"></i>Disabling active types may hide documents
                </p>
            </div>
        </div>
    </div>
