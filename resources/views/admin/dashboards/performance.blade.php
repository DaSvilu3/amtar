...
@section('title', 'Performance Dashboard - Amtar Admin')
...
@section('content')
    ...
    <div class="page-title d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="dashboard-selector">
            <select class="form-select" onchange="window.location.href=this.value" style="min-width: 200px; border: 2px solid var(--secondary-color); border-radius: 10px;">
                ...
                <option value="/admin/dashboards/performance" selected>Performance Dashboard</option>
            </select>
        </div>
    </div>
    ...
    @include('components.coming-soon', [
        ...
        'message' => 'KPI tracking, performance metrics, and business intelligence coming soon.',
        'progress' => 20
    ])
@endsection