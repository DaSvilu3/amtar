...
<div class="fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.notification-templates.create') }}" class="btn btn-primary">
            <i class="fas fa-plus me-2"></i>Add New Notification Template
        </a>
    </div>
    ...
    <div class="dashboard-card mb-4">
        <form action="{{ route('admin.notification-templates.index') }}" method="GET" class="row g-3">
            <div class="col-md-10">
                <input type="text" name="search" class="form-control" placeholder="Search notification templates..." value="{{ request('search') }}">
            </div>
            <div class="col-md-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.notification-templates.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.notification-templates.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.notification-templates.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-4">
                                ...
                                <p class="text-muted">No notification templates found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
