...
<div class="fade-in">
    ...
    <div class="dashboard-card">
        <form action="{{ route('admin.notification-templates.update', $item->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Update Notification Template
                </button>
            </div>
        </form>
    </div>
