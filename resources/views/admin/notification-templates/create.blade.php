...
<div class="fade-in">
    <div class="page-title mb-4">
        <h1>Create New Notification Template</h1>
    ...
    <div class="dashboard-card">
        <form action="{{ route('admin.notification-templates.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Create Notification Template
                </button>
            </div>
        </form>
    </div>
