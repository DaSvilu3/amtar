...
@section('title', 'Notification Template Details')
...
<div class="fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.notification-templates.edit', $item->id) }}" class="btn btn-warning">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="dashboard-card">
                <h5 class="mb-4"><i class="fas fa-bell me-2"></i>Information</h5>
