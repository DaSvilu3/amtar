...
@section('title', 'Message Template Details')

@section('content')
<div class="fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="page-title">
            <h1>Message Template Details</h1>
        ...
        <div>
            <a href="{{ route('admin.message-templates.edit', $item->id) }}" class="btn btn-warning">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="dashboard-card">
                <h5 class="mb-4"><i class="fas fa-comments me-2"></i>Information</h5>
